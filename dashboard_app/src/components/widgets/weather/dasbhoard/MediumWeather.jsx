...
export const MediumWeather = ({ city, unit, refreshRate }) => {
                    ...
                    <GridItem colSpan={3}>
                        <Flex w={"100%"} h="100%">
                            <Flex w={"80%"} h="100%" flexDir="column" justifyContent={"space-between"}>
                                <Flex><Text fontSize={"2xl"} fontWeight="bold">{city}</Text></Flex>
                                <Flex><Text fontSize={"xl"} fontWeight="bold">{data && data.widgetTemp} {unit}</Text></Flex>
                            </Flex>

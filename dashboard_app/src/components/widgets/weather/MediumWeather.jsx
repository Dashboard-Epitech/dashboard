...
export const MediumWeather = ({city, temp, unit, weatherDesc, weatherIcon, weatherBackground}) => {
    ...
    return (
        <>
            <Flex w={"60%"} h="150px" backgroundImage={weatherBackground ?? null} backgroundPosition="center" backgroundSize="cover" backGroundColor={"gray.600"} my={6} p={6} borderRadius={"20px"} color="white" >

...
export const SmallWeather = ({city, temp, unit, weatherDesc, weatherIcon, weatherBackground}) => {
    const renderWeatherIcon = () => {
        return weatherIcon ? <Image src={weatherIcon} boxSize={"40px"}></Image> : <FaQuestion size="5rem"/>;
    }
